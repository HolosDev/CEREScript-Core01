...
instance TextShow CERES where
  ...
  showb (CRSModifyValue3 vpA vpB cOper vpC) = showbCS4 "ModifyValue3" vpA vpB cOper vpC
  ...
  showb (CRSRandomWith vpA vtB vpC vpD vpE) = showbCS5 "RandomWith" vpA vtB vpC vpD vpE
  showb (CRSRandomWithBy vpA vpB vpC vpD vpE) = showbCS5 "RandomWithBy" vpA vpB vpC vpD vpE
  ...
  showb (CRSToInterpreter3 cH vpA vpB vpC) = showbCSC3 "ToInterpreter3" cH vpA vpB vpC
  showb (CRSToInterpreter4 cH vpA vpB vpC vpD) = showbCSC4 "ToInterpreter4" cH vpA vpB vpC vpD
  showb (CRSToInterpreter5 cH vpA vpB vpC vpD vpE) = showbCSC5 "ToInterpreter5" cH vpA vpB vpC vpD vpE
  showb (CRSToInterpreter6 cH vpA vpB vpC vpD vpE vpF) = showbCSC6 "ToInterpreter6" cH vpA vpB vpC vpD vpE vpF
  showb (CRSToInterpreter7 cH vpA vpB vpC vpD vpE vpF vpG) = showbCSC7 "ToInterpreter7" cH vpA vpB vpC vpD vpE vpF vpG
  showb (CRSToInterpreter8 cH vpA vpB vpC vpD vpE vpF vpG vpH) = showbCSC8 "ToInterpreter8" cH vpA vpB vpC vpD vpE vpF vpG vpH
  ...
  showb (CRSExtend4 cH vpA vpB vpC vpD) = showbCSC4 "Extend4" cH vpA vpB vpC vpD
  showb (CRSExtend5 cH vpA vpB vpC vpD vpE) = showbCSC5 "Extend5" cH vpA vpB vpC vpD vpE
  showb (CRSExtend6 cH vpA vpB vpC vpD vpE vpF) = showbCSC6 "Extend6" cH vpA vpB vpC vpD vpE vpF
  showb (CRSExtend7 cH vpA vpB vpC vpD vpE vpF vpG) = showbCSC7 "Extend7" cH vpA vpB vpC vpD vpE vpF vpG
  showb (CRSExtend8 cH vpA vpB vpC vpD vpE vpF vpG vpH) = showbCSC8 "Extend8" cH vpA vpB vpC vpD vpE vpF vpG vpH
...
data VariableIndex
  ...
  | VIpNRI NKey [Idx]
  | VIIRIT Idx [Idx] Time
  | VINRIT NKey [Idx] Time
  | VIpNRIT NKey [Idx] Time
  | VIV Value
  | VIAtom
  | VINull
  | VIPtr VariablePosition
  | PVII Idx
  | PVIN NKey
  | PVIpN NKey
  | PVIT Time
  ...
  | PVINRI NKey [Idx]
  | PVIpNRI NKey [Idx]
  | PVIIRIT Idx [Idx] Time
  | PVINRIT NKey [Idx] Time
  | PVIpNRIT NKey [Idx] Time
  deriving (Eq, Ord)
